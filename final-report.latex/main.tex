...
In order to calculate the gradient flow, we numerically solve the differential equation using a fourth-order Runga-Kutta approximation. We use an adaptive step size algorithm to dramatically increase efficiency.
