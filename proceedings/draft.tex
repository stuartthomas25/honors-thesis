...
\end{equation}
where we have assumed periodic boundary conditions. In the continuum limit, the topological susceptibility diverges owing solely to the $x^*=0$ term \cite{bietenholz2018}, a divergence that exists in QCD as well \cite{bruno2014}.
